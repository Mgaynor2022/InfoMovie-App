...
const MovieContext = (props) => {
  ...
  const [homePage, setHomePage] = useState([
    {
      ...
      poster:
        "https://m.media-amazon.com/images/M/MV5BZDkzOTFmMTUtMmI2OS00MDE4LTg5YTUtODMwNDMzNmI5OGYwL2ltYWdlXkEyXkFqcGdeQXVyMTQxNzMzNDI@._V1_SX300.jpg",
    },
    {
      title: "Training Day",
  ...
  function handleSubmit(e) {
    e.preventDefault();
    axios
      .get(`http://www.omdbapi.com/?t=${searchData.title}&apikey=9d97bb4b`)
  ...
  function addToFavoritesDb(newFavorite) {
    axios
      .post("/api/favoritesData", newFavorite)
      .then((res) => {
  ...
  function deleteFavoriteDb(favoriteId) {
    axios
      .delete(`/api/favoritesData/${favoriteId}`)
      .then((res) => {
        setFavorites((prevFav) =>
          prevFav.filter((favorite) => favorite._id !== favoriteId)
        );
      })
      .catch((err) => console.log(err));
  }
